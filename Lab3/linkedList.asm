...
Delete_x:
	beqz $a0, listEmpty #If head = 0, list is empty
	
	move $t0, $a0 #$t0 is temp pointer, it's equal to head at the beginning
	li $t1, 0#$t1 will be used for prev pointer
...
msg133: .asciiz "8 - invert the list \n"

msg134: .asciiz "9- display the list inverted \n"
